...
const WINDOW_CONFIG = {
  finder: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  contact: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  resume: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  safari: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  photos: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  terminal: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  txtfile: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
  imgfile: { isOpen: false, isMinimized: false, isMaximized: false, lastPos: null, lastSize: null, zIndex: INITIAL_Z_INDEX, data: null },
};
